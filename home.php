...
<header class="bg-dark py-5" id="main-header">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">"Planning an Event? Rent Beautiful Gowns and Personalized Backdrops Here!"</h1>
...
<section class="py-5" id="packages-section">
    <div class="container px-4 px-lg-5 mt-5">
        <div class="text-center mb-5">
            <h2 class="display-5 fw-bolder">Our Exclusive Event Packages</h2>
            <p class="lead fw-normal text-muted">Choose from a variety of packages designed to make your event truly special.</p>
        </div>
